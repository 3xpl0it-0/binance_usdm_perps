"""importing ticker name data into dataframe and csv file (csv saved if script ran as main)"""
...
def get_listing_and_final_date(
    ...
    """get listing and most recent date for each symbol"""
...
print('\nfinished getting symbols & start + end dates\n')
